...
-- A despejar estrutura da base de dados para intern_test
CREATE DATABASE IF NOT EXISTS `intern_test` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `intern_test`;

-- A despejar estrutura para tabela intern_test.cryptos
